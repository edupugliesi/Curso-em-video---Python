...
numTentativa = int(input('\nVamos jogar um jogo, tente adivinhar o número secreto. Insira um número de 0 a 10: '))

count = 0
while numTentativa != numSecreto:
    if numTentativa < numSecreto:
        numTentativa = int(input('Erôôôu, o número é maior tente novamente: '))
    if numTentativa > numSecreto:
        numTentativa = int(input('Erôôôu, o número é menor tente novamente: '))
    count += 1
