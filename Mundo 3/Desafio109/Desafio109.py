...
print(f'O dobro de {moeda.moeda(valor)} é {moeda.moeda(moeda.dobro(valor), format=True)}')
print(f'A metade de {moeda.moeda(valor)} é {moeda.moeda(moeda.metade(valor), format=True)}')