...
def resumo(valor, taxa):
    print('-')
    print(f'O valor de {moeda(valor, format=True)} aumentado em {taxa}% é {moeda(aumentar(valor, taxa), format=True)}')
    print(f'O valor de {moeda(valor, format=True)} diminuído em {taxa}% é {moeda(diminuir(valor, taxa), format=True)}')
